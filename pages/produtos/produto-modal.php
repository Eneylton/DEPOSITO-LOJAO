...
c.nome as categoria, 
p.aplicacao AS aplicacao', ' produtos AS p
INNER JOIN
...
$dados .= '    <div class="row">
               ...
               <div class="row">
                  ...
                  <div class="col-6">
                     <div class="form-group">
                        <label>Cargos</label>
                        <select class="form-control select caixa-alta" style="width: 100%;" name="categorias_id">
               ...
               <div class="row">
                  <div class="col-6">
                     <div class="form-group">
                        <label>Produto</label>
                        <input type="text" class="form-control caixa-alta" name="nome" value="'.$nome.'">
                     </div>
               ...
               <div class="row">
                  <div class="col-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="estoque" value="'.$qtd .'">
                     </div>
                  ...
                  <div class="col-8">
                     <div class="form-group">
                        ...
                        <textarea class="form-control caixa-alta" name="aplicacao" cols="60" rows="5">'.$descricao .'</textarea>
                     </div>
