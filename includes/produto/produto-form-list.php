...
foreach ($listar as $item) {
  ...
  $total = $quantidade * $item->valor_venda;
   ...
   if($item->barra == ""){
      ...
      $textobarras = '<span class="cinza">SEM COD BARRAS</span>';
   }else{

      $textobarras = '$item->barra';
   }


   $resultados .= '<tr>
   <td class="texto-medio">' . $contador . '</td>
   <td><img src="../.' . $foto . '" class="img-thumbnail foto2"></td>   
   <td><span  class="barra">' . $textobarras . '</span></td>
   ...
   <td> <button type="button" class="btn btn-warning"> R$ ' . number_format($item->valor_compra, "2", ",", ".") . '</button></td>
   
   <td> <button class="btn btn-info"> R$ ' . number_format($item->valor_venda, "2", ",", ".") . '</button></td>
               ...
               <div class="row">
                  <div class="col-6">
                     <div class="form-group">
                        ...
                        <input autofocus type="text" class="form-control" name="nome" style="text-transform: uppercase;">
                     </div>
